...
## Environments
- Preview: https://main--himanich-da--aemysites.aem.page/
- Live: https://main--himanich-da--aemysites.aem.live/
- Block Library: https://main--himanich-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `himanich-da` directory in your favorite IDE and start coding :)
